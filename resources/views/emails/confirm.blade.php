...
<div class="pt-5 mt-5 container">
    <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 offset-xs-3 offset-sm-3 offset-md-3 offset-lg-3 text-left pt-3">
          <form class="form-signin">
              <img class="mb-2" src="http://foxylabs.xyz/Documentos/imgs/TICKE3-8.png" alt="" width="150" height="50">
              <h1 class="h3 mb-3 font-weight-normal text-left  text-dark">{!! $username !!}, tus nuevos datos son:</h1>
